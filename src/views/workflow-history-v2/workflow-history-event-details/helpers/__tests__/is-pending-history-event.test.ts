...
import { allWorkflowEventTypesAttrsExtended } from '@/views/workflow-history-v2/__fixtures__/all-workflow-event-types-attributes';
import {
...
} from '@/views/workflow-history-v2/workflow-history-v2.types';
